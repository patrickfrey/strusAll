...
if(APPLE)
   ...
   set( CMAKE_INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/${LIB_INSTALL_DIR}/papuga" "${CMAKE_INSTALL_PREFIX}/${LIB_INSTALL_DIR}/strus" "${Boost_LIBRARY_DIRS}"  "${LevelDB_LIBRARY_PATH}" )
